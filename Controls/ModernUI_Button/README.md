...
For the x86 version of the ModernUI_Button control, visit [here](https://github.com/mrfearless/ModernUI/tree/master/Controls/ModernUI_Button).


## Setup ModernUI_Button

* Download the latest version of the ModernUI_Button and extract the files. The latest release can be found via the [releases](https://github.com/mrfearless/ModernUI64/releases) section of this Github repository or from the downloads section below.
* Copy the `ModernUI_Button.inc` file to your `UASM\include` folder (or wherever your includes are located)
* Copy the `ModernUI_Button.lib` file to your `UASM\lib\x64` folder (or wherever your libraries are located)
...
Documentation is available for the ModernUI_Button functions, styles and properties used by the control on the wiki: [ModernUI_Button Control](https://github.com/mrfearless/ModernUI64/wiki/ModernUI_Button-Control)

## ModernUI_Button Downloads
- Release: [ModernUI_Button.zip](https://github.com/mrfearless/ModernUI64/blob/master/Release/ModernUI_Button.zip?raw=true)
- Source: [ModernUI_Button_Source.zip](https://github.com/mrfearless/ModernUI64/blob/master/Release/ModernUI_Button_Source.zip?raw=true)