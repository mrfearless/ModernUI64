...
For the x86 version of the ModernUI_SmartPanel control, visit [here](https://github.com/mrfearless/ModernUI/Controls/ModernUI_SmartPanel).


## Setup ModernUI_SmartPanel

* Download the latest version of the ModernUI_SmartPanel and extract the files. The latest release can be found in the [Release](https://github.com/mrfearless/ModernUI64/tree/master/Release) folder, or via the [releases](https://github.com/mrfearless/ModernUI64/releases) section of this Github repository or can be downloaded directly from [here](https://github.com/mrfearless/ModernUI64/blob/master/Release/ModernUI_SmartPanel.zip?raw=true).
