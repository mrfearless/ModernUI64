...
For the x86 version of the ModernUI_CaptionBar control, visit [here](https://github.com/mrfearless/ModernUI/tree/master/Controls/ModernUI_CaptionBar).


## Setup ModernUI_CaptionBar

* Download the latest version of the ModernUI_CaptionBar and extract the files. The latest release can be found via the [releases](https://github.com/mrfearless/ModernUI64/releases) section of this Github repository or from the downloads section below.
* Copy the `ModernUI_CaptionBar.inc` file to your `UASM\include` folder (or wherever your includes are located)
* Copy the `ModernUI_CaptionBar.lib` file to your `UASM\lib\x64` folder (or wherever your libraries are located)
...
Documentation is available for the ModernUI_CaptionBar functions, styles and properties used by the control on the wiki: [ModernUI_CaptionBar Control](https://github.com/mrfearless/ModernUI64/wiki/ModernUI_CaptionBar-Control)

## ModernUI_CaptionBar Downloads
- Release: [ModernUI_CaptionBar.zip](https://github.com/mrfearless/ModernUI64/blob/master/Release/ModernUI_CaptionBar.zip?raw=true)
- Source: [ModernUI_CaptionBar_Source.zip](https://github.com/mrfearless/ModernUI64/blob/master/Release/ModernUI_CaptionBar_Source.zip?raw=true)
