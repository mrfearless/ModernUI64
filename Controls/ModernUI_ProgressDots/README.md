...
For the x86 version of the ModernUI_ProgressDots control, visit [here](https://github.com/mrfearless/ModernUI/tree/master/Controls/ModernUI_ProgressDots).


## Setup ModernUI_ProgressDots

* Download the latest version of the ModernUI_ProgressDots and extract the files. The latest release can be found via the [releases](https://github.com/mrfearless/ModernUI64/releases) section of this Github repository or from the downloads section below.
* Copy the `ModernUI_ProgressDots.inc` file to your `UASM\include` folder (or wherever your includes are located)
* Copy the `ModernUI_ProgressDots.lib` file to your `UASM\lib\x64` folder (or wherever your libraries are located)
...
Documentation is available for the ModernUI_ProgressDots functions, styles and properties used by the control on the wiki: [ModernUI_ProgressDots Control](https://github.com/mrfearless/ModernUI64/wiki/ModernUI_ProgressDots-Control)

## ModernUI_ProgressDots Downloads
- Release: [ModernUI_ProgressDots.zip](https://github.com/mrfearless/ModernUI64/blob/master/Release/ModernUI_ProgressDots.zip?raw=true)
- Source: [ModernUI_ProgressDots_Source.zip](https://github.com/mrfearless/ModernUI64/blob/master/Release/ModernUI_ProgressDots_Source.zip?raw=true)
