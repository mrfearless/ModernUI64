...
* Download the latest version of the ModernUI_ProgressDots and extract the files. The latest release can be found in the [Release](https://github.com/mrfearless/ModernUI64/tree/master/Release) folder, or via the [releases](https://github.com/mrfearless/ModernUI64/releases) section of this Github repository or can be downloaded directly from [here](https://github.com/mrfearless/ModernUI64/blob/master/Release/ModernUI_ProgressDots.zip?raw=true).
* Copy the `ModernUI_ProgressDots.inc` file to your `UASM\include` folder (or wherever your includes are located)
* Copy the `ModernUI_ProgressDots.lib` file to your `UASM\lib` folder (or wherever your libraries are located)
