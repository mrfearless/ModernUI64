...
void MUI_EXPORT MUIGDIPaintFill(HDC hdc, LPRECT *lpFillRect, MUICOLORRGB FillColor);
void MUI_EXPORT MUIGDIPaintFrame(HDC hdc, LPRECT *lpFrameRect, MUICOLORRGB FrameColor, MUIPFS FrameStyle);
