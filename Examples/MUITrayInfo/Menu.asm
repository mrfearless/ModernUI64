TrayMenuInit            PROTO :QWORD
TrayMenuSelection       PROTO :QWORD,:QWORD
TrayMenuUpdate          PROTO :QWORD
...
; Init tray menu
;-------------------------------------------------------------------------------------
TrayMenuInit PROC FRAME hWin:QWORD
    Invoke CreatePopupMenu
    mov hTrayMenu, rax

    Invoke CreatePopupMenu
    mov hTMSubMenuIcons, rax
...
;-------------------------------------------------------------------------------------
TrayMenuUpdate PROC FRAME hWin:QWORD
